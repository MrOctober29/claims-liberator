...
\
# --- UI: MAIN AREA ---\
st.title("\uc0\u55357 \u56458  Claims Analysis Dashboard")\
\
# 1. THE DROP ZONE\
...
if uploaded_file:\
    ...
    if not df.empty:\
        ...
        with st.expander("\uc0\u55357 \u56589  Sanity Check (Validate Data)", expanded=True):\
            col1, col2 = st.columns([1, 2])\
            with col1:\
                st.markdown("### Source Validation")\
                st.write("Review the extracted numbers against your PDF.")\
                st.warning("\uc0\u9888 \u65039  If you see a discrepancy, you can edit the values in the grid directly.")\
            with col2:\
        ...
        st.divider()\
        st.subheader("\uc0\u55357 \u56520  Monthly Cost Analysis")\
        \
        # Metrics Row\
